...
static config_entry_S config_entries[CONFIG_ENTRY_COUNT] = {
  ...
  [CONFIG_ENTRY_SENSOR_GAIN_0]  = { CONFIG_ENTRY_SENSOR_GAIN_0,   "gain_0",    -5.0  },
  ...
  [CONFIG_ENTRY_SENSOR_GAIN_4]  = { CONFIG_ENTRY_SENSOR_GAIN_4,   "gain_4",     1.5  },
  [CONFIG_ENTRY_SENSOR_GAIN_5]  = { CONFIG_ENTRY_SENSOR_GAIN_5,   "gain_5",     5.0  },
